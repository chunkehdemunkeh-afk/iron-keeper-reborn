...
export const WORKOUTS: WorkoutDay[] = [
  ...
  // ── Upper/Lower A/B (DUP) ─────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: "lib-db-One-Arm_Incline_Lateral_Raise", name: "One-Arm Incline Lateral Raise", sets: 2, reps: "12-15", targetMuscle: "Side Delts", targetRir: "1-2", notes: "Lie sideways on an incline bench, dumbbell in top hand. Raise to shoulder height, full stretch at bottom. Each side." },
