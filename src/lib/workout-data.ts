...
export const WORKOUTS: WorkoutDay[] = [
  ...
  // ── Upper/Lower A/B (DUP) ─────────────────────────────────────────────────
  {
    ...
    exercises: [
      { id: "pu2",       name: "Barbell Bench Press",              sets: 4, reps: "6-8",   targetMuscle: "Chest",          notes: "Top strength lift — chase a heavy top set, controlled eccentric, pause if grinding" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "dl5", name: "Single Arm Dumbbell Row",                     sets: 3, reps: "10-12 each", targetMuscle: "Lats/Mid Back",     notes: "Unilateral row — full stretch at bottom, drive elbow back" },
