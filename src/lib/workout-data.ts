...
export const WORKOUTS: WorkoutDay[] = [
  ...
  // ── Upper/Lower A/B (DUP) ─────────────────────────────────────────────────
  {
    ...
    targetRir: "1-2",
    exercises: [
      { id: "lib-1",     name: "Barbell Bench Press",                          sets: 2, reps: "6-8",   targetMuscle: "Chest",          targetRir: "0-1", notes: "Top strength lift — chase a heavy top set, controlled eccentric, pause if grinding" },
      { id: "lib-64",    name: "Mag Grip Seated Cable Row",                    sets: 2, reps: "6-8",   targetMuscle: "Back Thickness", targetRir: "0-1", notes: "Mag (neutral) grip — pull to lower chest, drive elbows back, squeeze shoulder blades, full stretch at extension. Don't chase old T-Bar weights — cable mechanics differ" },
      { id: "pu1",       name: "45° Incline Dumbbell Bench Press",             sets: 2, reps: "6-8",   targetMuscle: "Upper Chest",    targetRir: "0-1", notes: "Strength focus — heavier load, full stretch at bottom, controlled eccentric" },
      { id: "pl3",       name: "Lat Pulldown - Pronated Grip",                 sets: 2, reps: "6-8",   targetMuscle: "Lats",           targetRir: "0-1", notes: "Strength focus — heavier load, full stretch at top, drive elbows down hard" },
      { id: "lib-db-Smith_Machine_Overhead_Shoulder_Press", name: "Smith Machine Seated Military Press", sets: 2, reps: "6-8", targetMuscle: "Shoulders", targetRir: "0-1", notes: "Bar to upper chest, push straight up, full lockout. Elbows slightly in front — not flared wide. Fixed bar path allows heavier loading than DB press" },
      ...
      { id: "lib-62",    name: "Plate Loaded Dip Machine",                     sets: 2, reps: "6-8",   targetMuscle: "Triceps",        targetRir: "0-1", notes: "Heavy triceps press — torso upright, full lockout at top, controlled stretch at bottom" },
      { id: "pu5",       name: "X-Over Cable Tricep Extensions",               sets: 2, reps: "10-12", targetMuscle: "Triceps",        targetRir: "0-1", notes: "Tricep finisher — lock elbows in place, full extension, squeeze the lockout" },
    ],
  },
  {
    id: "lower_a",
    ...
    exercises: [
      ...
      { id: "lib-66", name: "Box Jumps with Drop Jump", sets: 3, reps: "5",     targetMuscle: "Power/Reactive",    notes: "EXPLOSIVE BLOCK. Jump onto box, step off (do NOT jump off), land softly, immediately jump again from landing. The reactive landing is the stimulus. 90s rest. Log box height in inches.", trackWeight: true, weightLabel: "Height (in)" },
      ...
      { id: "lg4", name: "Pendulum Squat",              sets: 2, reps: "8-10",  targetMuscle: "Quads",             targetRir: "0-1", notes: "STRENGTH BLOCK. Reduced to 3 sets — higher reps to account for pre-fatigue from explosive block. Deep ROM, drive through midfoot. 2.5–3 min rest" },
      ...
      { id: "lg5", name: "Leg Extension",               sets: 2, reps: "12-15", targetMuscle: "Quads",             targetRir: "0-1", notes: "Push toward 65kg. Squeeze at top, 2s hold. 90s rest" },
      { id: "lg6", name: "Standing Calf Raise",         sets: 2, reps: "15-20", targetMuscle: "Calves",            targetRir: "0-1", notes: "Full stretch at bottom every rep, pause at top. 90s rest" },
      ...
      { id: "lib-db-Machine_Preacher_Curls", name: "Machine Preacher Curl", sets: 2, reps: "10-12", targetMuscle: "Biceps", targetRir: "0-1", notes: "Arms locked on pad, controlled out of bottom, full squeeze at top" },
      { id: "lib-61", name: "Bayesian Curl",            sets: 2, reps: "10-12", targetMuscle: "Biceps",            targetRir: "0-1", notes: "45° cable behind body. Long head stretch. Slow eccentric" },
    ],
  },
  {
    id: "upper_b",
    ...
    exercises: [
      ...
      { id: "lib-13",    name: "Face Pulls",                       sets: 2, reps: "15-20", targetMuscle: "Rear Delts",        targetRir: "0-1", notes: "Non-negotiable for shoulder longevity — kneeling, rope to forehead, double bicep finish, 1-2s squeeze" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lg1",              name: "Seated Hamstring Curl",    sets: 2, reps: "10-12", targetMuscle: "Hamstrings",        targetRir: "0-1", notes: "STRENGTH BLOCK. Reduced to 3 sets — Nordics already pre-loaded hamstrings. Squeeze at bottom, slow negative. 90s rest" },
      { id: "fb2",              name: "Romanian Deadlift",        sets: 2, reps: "8-10",  targetMuscle: "Hamstrings/Glutes", targetRir: "0-1", notes: "Reduced to 3 sets. Barbell if available. Slow 3s eccentric, hip hinge. Currently at 60kg. 2 min rest" },
