...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "la6", name: "Core Finisher",               sets: 3, reps: "12-15", targetMuscle: "Core",              targetRir: "1-2", notes: "Pick a variant from the dropdown — 60s rest" },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lib-29",           name: "Nordic Hamstring Curl",    sets: 3, reps: "5",     targetMuscle: "Hamstrings",        notes: "EXPLOSIVE BLOCK. Kneel on pad, anchor feet. Lower body under hamstring control only — as slow as possible (build from 3–4s to 6–8s over weeks). Catch with hands, push back up. Non-negotiable for injury prevention. 90s rest." },
