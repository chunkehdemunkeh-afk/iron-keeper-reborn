...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lb7",              name: "Oblique Leg Raises",        sets: 3, reps: "12",    targetMuscle: "Core/Obliques",     notes: "Core finisher — rotate with Russian Twists or Decline Crunch", trackWeight: false },
