...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lg4", name: "Pendulum Squat",              sets: 2, reps: "8-10",  targetMuscle: "Quads",             targetRir: "0-1", notes: "COMPOUND. Higher reps to account for pre-fatigue from explosive block. Deep ROM, drive through midfoot. 2.5–3 min rest" },
