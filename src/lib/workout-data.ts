...
export const WORKOUTS: WorkoutDay[] = [
  ...
  // ── Upper/Lower A/B (DUP) ─────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: "ua6",       name: "Cable Lateral Raises",             sets: 4, reps: "12-15", targetMuscle: "Side Delts",     targetRir: "1-2", notes: "Constant tension through full ROM — reach across body at bottom" },
  ...
  },
  {
    ...
    targetRir: "1-2",
    exercises: [
      { id: "lib-65", name: "Hex Bar Squat Jumps",     sets: 4, reps: "4",     targetMuscle: "Quads/Power",       notes: "EXPLOSIVE BLOCK — do first. Moderate hex bar load. Explosive drive from floor, full hip extension, soft landing, fully reset before next rep. 90s rest. Quality over speed." },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lib-18", name: "Incline Dumbbell Curl",                     sets: 3, reps: "10-12",     targetMuscle: "Biceps",            notes: "Extra biceps volume to match PPLU — long head stretch" },
      { id: "lib-13", name: "Face Pulls",                               sets: 3, reps: "15-20",     targetMuscle: "Rear Delts",        notes: "Non-negotiable for shoulder longevity — high pull, external rotate at top" },
      { id: "dl5", name: "Dumbbell Row",                                sets: 3, reps: "10-12",     targetMuscle: "Lats/Mid Back",     notes: "Two-handed bent-over row — full stretch at bottom, drive elbows back. Toggle 1 Arm pill for unilateral" },
      ...
      { id: "lib-19", name: "Tricep Pushdown",                           sets: 3, reps: "12-15",     targetMuscle: "Triceps",           notes: "Split the rope at the bottom, squeeze triceps" },
    ],
  },
  {
    id: "lower_b",
    ...
    exercises: [
      ...
      { id: "lib-db-Hack_Squat", name: "Hack Squat",              sets: 3, reps: "10-12", targetMuscle: "Quads",             notes: "Quad variation vs Pendulum on A day — full depth, controlled descent" },
      { id: "lb4",              name: "Single-Leg Lying Curl",     sets: 3, reps: "12-15", targetMuscle: "Hamstrings",        notes: "Unilateral — addresses any left/right imbalances" },
      { id: "rf3",              name: "Farmer's Walk",             sets: 3, reps: "30-40", targetMuscle: "Grip/Traps/Core",   notes: "Heavy as possible, shoulders back and down", repLabel: "Metres" },
      { id: "lg6",              name: "Standing Calf Raise",       sets: 3, reps: "20",    targetMuscle: "Calves",            notes: "Second calf stimulus for the week — full ROM, full stretch at bottom" },
      { id: "lb7",              name: "Weighted Decline Crunch",   sets: 3, reps: "12",    targetMuscle: "Abs",               notes: "Plate on chest — full range, controlled descent", trackWeight: true },
      { id: "lib-42",           name: "Wrist Curls",               sets: 3, reps: "12-15", targetMuscle: "Forearms",          notes: "During rest periods — forearms on bench, palms up, full ROM" },
      { id: "lib-63",           name: "Reverse Wrist Curls",       sets: 3, reps: "12-15", targetMuscle: "Forearms",          notes: "During rest periods — forearms on bench, palms down, targets extensors" },
    ],
  },
];
