...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lib-db-Hyperextensions_Back_Extensions", name: "45° Hyperextension", sets: 3, reps: "10-12", targetMuscle: "Lower Back/Glutes/Hamstrings", targetRir: "1-2", notes: "45° bench, slow controlled extension, squeeze glutes at top. Hold a plate to chest for added load. 90s rest" },
