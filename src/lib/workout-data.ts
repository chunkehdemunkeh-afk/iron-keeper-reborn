...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lg4", name: "Pendulum Squat",              sets: 2, reps: "5-10",  targetMuscle: "Quads",             targetRir: "0-1", notes: "Feet mid-platform, deep range of motion, drive through the midfoot. Keep the descent controlled rather than dropping into the bottom." },
      { id: "lg3", name: "Bulgarian Split Squats",      sets: 2, reps: "5-10",    targetMuscle: "Quads/Glutes",      targetRir: "0-1", notes: "Each side. Rear foot elevated, front shin roughly vertical, torso slightly forward. Control the descent and drive through the front heel." },
      { id: "lg5", name: "Leg Extension",               sets: 2, reps: "5-10", targetMuscle: "Quads",             targetRir: "0-1", notes: "Align the knee joint with the machine pivot. Squeeze for a 2s hold at the top and lower under control — no swinging." },
      { id: "lg6", name: "Standing Calf Raise",         sets: 2, reps: "5-10", targetMuscle: "Calves",            targetRir: "0-1", notes: "Let the heels drop for a full stretch every rep, then rise onto the big toe and pause a beat at the top." },
      { id: "la6", name: "Core Finisher",               sets: 2, reps: "5-10", targetMuscle: "Core",              targetRir: "0-1", notes: "Pick a variant from the dropdown. Move slowly and keep tension on the abs rather than chasing reps." },
      { id: "lib-db-Machine_Preacher_Curls", name: "Machine Preacher Curl", sets: 2, reps: "5-10", targetMuscle: "Biceps", targetRir: "0-1", notes: "Chest against the pad, upper arms flat throughout. Control out of the bottom — don't bounce — and squeeze hard at the top." },
      { id: "lib-61", name: "Bayesian Curl",            sets: 2, reps: "5-10", targetMuscle: "Biceps",            targetRir: "0-1", notes: "Stand a step in front of a low cable so the arm hangs behind the torso. That stretched start hits the long head — slow eccentric each rep." },
  ...
  },
  {
    ...
    targetRir: "1-2",
    exercises: [
      { id: "pu3",       name: "15° Incline Dumbbell Bench Press", sets: 2, reps: "5-10", targetMuscle: "Upper Chest",       targetRir: "0-1", notes: "A shallow incline keeps more load on the mid-chest. Lower slowly to a deep stretch, then press and squeeze the chest at the top." },
      { id: "pl1",       name: "Seated Row Machine",               sets: 2, reps: "5-10", targetMuscle: "Mid Back",          targetRir: "0-1", notes: "Neutral grip, chest tall against the pad. Pull to the lower chest, hold the squeeze, and let the shoulder blades travel forward on the return." },
      { id: "up4",       name: "Cable Flies To Thighs",            sets: 2, reps: "5-10", targetMuscle: "Lower Chest",       targetRir: "0-1", notes: "Set the pulleys high and sweep down toward the thighs in an arc. Slight elbow bend held constant, squeeze for a beat at the bottom." },
      { id: "lib-18",    name: "Incline Dumbbell Curl",            sets: 2, reps: "5-10", targetMuscle: "Biceps",            targetRir: "0-1", notes: "Bench at about 45° so the arms hang behind the torso for a long-head stretch. Keep the elbows still and only log clean, uncheated reps." },
      { id: "lib-64",    name: "Single-Arm Cable Reverse Fly",     sets: 2, reps: "5-10", targetMuscle: "Rear Delts",        targetRir: "0-1", notes: "Chest-height pulley, handle in the far hand across the body. Sweep out and back in an arc with a soft elbow and squeeze the rear delt. Both sides." },
      { id: "dl5",       name: "Chest Supported Dumbbell Row",     sets: 2, reps: "5-10", targetMuscle: "Lats/Mid Back",     targetRir: "0-1", notes: "Chest on an incline bench so the torso can't swing. Let the dumbbells hang for a full stretch, then drive the elbows back toward the hips." },
      { id: "lib-db-One-Arm_Incline_Lateral_Raise", name: "One-Arm Incline Lateral Raise", sets: 2, reps: "5-10", targetMuscle: "Side Delts", targetRir: "0-1", notes: "Lie sideways on an incline bench with the dumbbell in the top hand. Raise to shoulder height, lower fully for the stretch. Both sides." },
      { id: "ub6",       name: "Rope Hammer Curl (Cable)",         sets: 2, reps: "5-10", targetMuscle: "Biceps/Brachialis", targetRir: "0-1", notes: "Neutral rope grip with elbows pinned to the sides. Cable keeps tension constant — split the rope apart at the top of each rep." },
      { id: "sub-up5a",  name: "Dumbbell Shoulder Press",          sets: 2, reps: "5-10", targetMuscle: "Shoulders",         targetRir: "0-1", notes: "Free weights demand more stability than a machine. Brace the core, press to lockout without flaring the elbows straight out to the sides." },
      { id: "lib-19",    name: "Tricep Pushdown",                  sets: 2, reps: "5-10", targetMuscle: "Triceps",           targetRir: "0-1", notes: "Elbows tucked and still, lean slightly forward. Extend fully and split the rope at the bottom for an extra squeeze." },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lg1",              name: "Seated Hamstring Curl",    sets: 2, reps: "5-10", targetMuscle: "Hamstrings",        notes: "Keep the hips pinned to the seat, curl all the way down, hold the squeeze and resist on the way back up.", targetRir: "0-1" },
      { id: "fb2",              name: "Romanian Deadlift",        sets: 2, reps: "5-10",  targetMuscle: "Hamstrings/Glutes", targetRir: "0-1", notes: "Soft knees, push the hips back and keep the bar tight to the legs. Slow 3s eccentric until you feel the hamstring stretch, then drive the hips forward." },
      { id: "lib-db-Hack_Squat", name: "Hack Squat",              sets: 2, reps: "5-10", targetMuscle: "Quads",             targetRir: "0-1", notes: "Feet low and shoulder width to bias the quads. Controlled descent to full depth, no bouncing out of the bottom." },
      { id: "lib-db-Hyperextensions_Back_Extensions", name: "45° Hyperextension", sets: 2, reps: "5-10", targetMuscle: "Lower Back/Glutes/Hamstrings", targetRir: "0-1", notes: "Pads just below the hip crease. Round slightly down, extend under control and squeeze the glutes at the top. Hold a plate to the chest to add load." },
      { id: "lg6",              name: "Standing Calf Raise",      sets: 2, reps: "5-10",    targetMuscle: "Calves",            targetRir: "0-1", notes: "Full range every rep — heels dropped low for the stretch, pause at the top. Higher reps respond well here." },
      { id: "la6",              name: "Core Finisher",            sets: 2, reps: "5-10", targetMuscle: "Core",              targetRir: "0-1", notes: "Pick a variant from the dropdown. Move slowly and keep tension on the abs rather than chasing reps." },
