...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lib-13",    name: "Face Pulls",                       sets: 2, reps: "5-10", targetMuscle: "Rear Delts",        targetRir: "0-1", notes: "Rope set at face height. Pull toward the forehead, externally rotate into a double-bicep finish and hold 1-2s. Great for shoulder health." },
      { id: "dl5",       name: "Dumbbell Row",                     sets: 2, reps: "5-10", targetMuscle: "Lats/Mid Back",     targetRir: "0-1", notes: "Flat back, let the dumbbell hang for a full stretch, then drive the elbow back toward the hip. Toggle the 1 Arm pill for single-arm." },
      { id: "lib-db-One-Arm_Incline_Lateral_Raise", name: "One-Arm Incline Lateral Raise", sets: 2, reps: "5-10", targetMuscle: "Side Delts", targetRir: "0-1", notes: "Lie sideways on an incline bench with the dumbbell in the top hand. Raise to shoulder height, lower fully for the stretch. Both sides." },
