...
export const WORKOUTS: WorkoutDay[] = [
  ...
  // ── Upper/Lower A/B (DUP) ─────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: "pu1",      name: "45° Incline Dumbbell Bench Press",      sets: 3, reps: "8-10",  targetMuscle: "Upper Chest",    notes: "Control the eccentric, full stretch at bottom" },
      { id: "pl3",      name: "Lat Pulldown - Pronated Grip",          sets: 3, reps: "8-10",  targetMuscle: "Lats",           notes: "Full stretch at top, squeeze at bottom" },
      ...
      { id: "pu5",      name: "X-Over Cable Tricep Extensions",        sets: 3, reps: "10-12", targetMuscle: "Triceps",        notes: "Lock elbows in place, full extension at bottom" },
    ],
  },
  {
    id: "lower_a",
