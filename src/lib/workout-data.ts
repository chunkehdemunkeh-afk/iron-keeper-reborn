...
export const WORKOUTS: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: "lg1",              name: "Seated Hamstring Curl",    sets: 2, reps: "10-12", targetMuscle: "Hamstrings",        targetRir: "0-1", notes: "ISOLATION. Nordics already pre-loaded hamstrings. Squeeze at bottom, slow negative. 90s rest" },
      { id: "fb2",              name: "Romanian Deadlift",        sets: 2, reps: "8-10",  targetMuscle: "Hamstrings/Glutes", targetRir: "0-1", notes: "COMPOUND. Barbell if available. Slow 3s eccentric, hip hinge. 2 min rest" },
      { id: "lib-db-Hack_Squat", name: "Hack Squat",              sets: 2, reps: "10-12", targetMuscle: "Quads",             targetRir: "0-1", notes: "Quad variation vs Pendulum — full depth, controlled descent. Open at 90kg next session. 90s rest" },
      { id: "lib-db-Hyperextensions_Back_Extensions", name: "45° Hyperextension", sets: 2, reps: "10-12", targetMuscle: "Lower Back/Glutes/Hamstrings", targetRir: "0-1", notes: "45° bench, slow controlled extension, squeeze glutes at top. Hold a plate to chest for added load. 90s rest" },
      { id: "lg6",              name: "Standing Calf Raise",      sets: 2, reps: "20",    targetMuscle: "Calves",            targetRir: "0-1", notes: "Second calf stimulus for the week — full ROM, full stretch at bottom. 90s rest" },
